...
// 원본 통화·금액을 같이 들고 다니는 표준 Money 객체.
...
export function makeMoney(amount: number, currency: Currency = 'KRW'): Money {
...
export function toCurrency(krw: number, currency: Currency): number {
...
export function formatMoney(krw: number, currency: Currency): string {
