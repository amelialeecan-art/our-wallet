...
const UI: Group = {
  ...
  // 공동지갑 공유 (Firestore 동기화)
  'settings.shareGroup': { ko: '공동지갑', en: 'Shared wallet' },
  'settings.share': { ko: '공동지갑 공유', en: 'Share wallet' },
  'share.title': { ko: '공동지갑 공유', en: 'Shared wallet' },
  'share.intro': {
    ko: '같은 링크를 연 기기는 같은 우리지갑을 실시간으로 함께 봅니다. 태너에게 링크를 보내면 각자 폰에서 함께 기록할 수 있어요.',
  ...
  'share.status.loading': { ko: '원격 데이터 불러오는 중…', en: 'Loading remote data…' },
  'share.status.syncing': { ko: '저장 중…', en: 'Saving…' },
  'share.status.synced': { ko: '동기화됨', en: 'Synced' },
  'share.status.offline': { ko: '오프라인 (이 기기에 임시 저장)', en: 'Offline (saved on this device)' },
  'share.status.missing': { ko: '원격 지갑 없음 (저장 안 함)', en: 'No remote wallet (not saving)' },
  'share.missingNote': {
    ko: '이 링크의 공동지갑 문서가 아직 없어요. 잘못된 링크일 수 있어 자동 저장하지 않습니다. 데이터를 잃지 않으려면 링크를 다시 확인하세요.',
    en: 'No shared wallet exists for this link yet. To avoid data loss it will not auto-upload. Double-check the link.',
  },
  'share.remoteUpdatedAt': { ko: '마지막 원격 저장', en: 'Last remote save' },
  'share.remoteUpdatedBy': { ko: '마지막 저장 기기', en: 'Last saved by' },
  'share.dangerZone': { ko: '주의 (덮어쓰기)', en: 'Danger (overwrite)' },
  'share.mode': { ko: '모드', en: 'Mode' },
  'share.mode.shared': { ko: '공동지갑 (실시간 공유)', en: 'Shared (live)' },
  'share.mode.local': { ko: '로컬 (이 기기 전용)', en: 'Local (this device)' },
  'share.role': { ko: '이 기기 역할', en: 'This device role' },
  'share.walletId': { ko: '지갑 ID', en: 'Wallet ID' },
  'share.link': { ko: '공유 링크', en: 'Share link' },
  ...
  'share.createNote': {
    ...
    en: 'Creates a new shared wallet from this device’s data. Then send the link to Tanner.',
  },
  'share.created': { ko: '공동지갑을 만들었어요. 링크를 복사해 보내세요', en: 'Shared wallet created — copy the link and send it' },
  'share.upload': { ko: '이 기기 데이터로 덮어쓰기', en: 'Overwrite with this device' },
  'share.uploadNote': { ko: '공동지갑 내용을 이 기기의 데이터로 덮어써요.', en: 'Replaces the shared wallet with this device’s data.' },
  'share.uploaded': { ko: '공동지갑에 올렸어요', en: 'Uploaded to shared wallet' },
  'share.reload': { ko: '공동지갑에서 다시 불러오기', en: 'Reload from shared wallet' },
  'share.reloadNote': { ko: '공동지갑의 최신 내용을 이 기기로 다시 불러와요.', en: 'Pulls the latest shared data onto this device.' },
  'share.reloaded': { ko: '공동지갑에서 불러왔어요', en: 'Reloaded from shared wallet' },
  'share.warn': {
    ko: '⚠️ 이 링크를 가진 사람은 누구나 우리 가계부를 보고 고칠 수 있어요. 태너에게만 보내세요.',
    en: '⚠️ Anyone with this link can view and edit our wallet. Only send it to Tanner.',
  },
  'share.unavailable': {
    ko: '이 앱에 Firebase 설정이 없어 공동지갑을 쓸 수 없어요. 지금은 이 기기에만 저장돼요.',
    en: 'Firebase is not configured, so sharing is off. Data is saved on this device only.',
  },
  'share.setupHint': {
    ko: '공동지갑을 켜려면 Firebase 설정(환경변수)이 필요해요. README를 참고하세요.',
    en: 'To enable sharing, configure Firebase env vars. See the README.',
  },
  // 앱 설치 안내
